...
[SEGMENT .text]
	...
	call _display_endl
    mov si, strWelcomeMsg2   ; load message
    mov al, 0x01            ; request sub-service 0x01
    int 0x21
	call _display_endl	
...
SEGMENT .data]
    	strWelcomeMsg		db	"Hello... Welcome to Bitty2 ..", 0x00
    	strWelcomeMsg2		db	"Type help to get help", 0x00
	strPrompt		db	"Bitty>> ", 0x00
	cmdMaxLen		db	255			;maximum length of commands
	strOsName		db	"Bitty2", 0x00	;OS details
	strMajorVer		db	"1", 0x00
	strMinorVer		db	".00", 0x00
	txtdev			db	"Developed by Tharindu", 0x00
	...
	msgUnknownCmd		db	" Oh unknown command, Plese type help to get 'help' menu", 0x00
	strHelpMsg0		db 	" Type help  for help menu",0x00
	strHelpMsg1		db 	" Type ver   for version",0x00 
	strHelpMsg2		db 	" Type boot  for Reboot",0x00
	strHelpMsg3		db 	" Type exit  for shutdown",0x00
    	strHelpMsg4     	db 	" Type info  for hardware informations", 0x00
